...
export default async function HomeownerJobsPageBR() {
  ...
  if (!user) {
    redirect("/auth/login?locale=pt-BR&returnUrl=/br/dashboard/homeowner/jobs")
  }
  ...
  if (jobsError) {
    console.error("[HOMEOWNER-JOBS-BR] Error fetching jobs:", jobsError)
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <Link href="/br/dashboard/homeowner">
          ...
          <Link href="/br/dashboard/homeowner/post-job">
            <Button>
                ...
                <Card key={job.id} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                      ...
                      <Link href={`/br/dashboard/homeowner/jobs/${job.id}`}>
