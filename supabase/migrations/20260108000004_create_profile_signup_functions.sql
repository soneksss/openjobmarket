-- Migration: Create Profile Creation Functions for Signup
-- Date: 2026-01-08
-- Description: SECURITY DEFINER functions to bypass RLS during profile creation at signup

-- ============================================================================
-- PART 1: PROFESSIONAL PROFILE CREATION FUNCTION
-- ============================================================================
...
-- ============================================================================
-- PART 2: COMPANY PROFILE CREATION FUNCTION
-- ============================================================================
...
-- ============================================================================
-- PART 3: HOMEOWNER PROFILE CREATION FUNCTION
-- ============================================================================
...
WHERE routine_schema = 'public'
  AND routine_name IN (
    'create_professional_profile_on_signup',
    'create_company_profile_on_signup',
    'create_homeowner_profile_on_signup'
  )
