-- =====================================================
-- ADD COMPANY SUPPORT TO SAVED_JOBS V2
-- =====================================================
-- Fixed version that properly drops existing policies
-- =====================================================
...
-- Step 5: Drop ALL existing policies (outside DO block)
...
DROP POLICY IF EXISTS "Professionals can view their saved jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Professionals can save jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Professionals can delete saved jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Users can insert saved jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Users can manage saved jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Companies can save jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Companies can view saved jobs" ON public.saved_jobs;
DROP POLICY IF EXISTS "Companies can delete saved jobs" ON public.saved_jobs;
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'All done! Companies can now save jobs.';
    RAISE NOTICE '====================================';
END $$;
