-- ============================================================
-- Fix: search_traders was returning NULL for company rating
-- and reviews_count. Now returns the real values.
-- ============================================================
...
AS $$
  ...
  SELECT
    ...
    cp.average_rating::double precision        AS rating,
    cp.reviews_count::int,
    cp.user_id,
...
DO $$ BEGIN
  RAISE NOTICE '✓ search_traders — company average_rating and reviews_count now returned';
END $$;
