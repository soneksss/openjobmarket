...
export function CategoryCarousel({ onCategoryClick }: CategoryCarouselProps) {
  ...
  const popularCategories: Category[] = [
    ...
    { key: "roofer", icon: "🏠", color: "from-slate-600 to-slate-700" },
    { key: "builder", icon: "🏗️", color: "from-slate-600 to-slate-700" },
    { key: "handyman", icon: "🔨", color: "from-slate-600 to-slate-700" },
    { key: "manAndVan", icon: "🚚", color: "from-slate-600 to-slate-700" },
    { key: "gardener", icon: "🌿", color: "from-slate-600 to-slate-700" },
    { key: "plasterer", icon: "🧱", color: "from-slate-600 to-slate-700" },
    ...
    { key: "tiler", icon: "⬜", color: "from-slate-600 to-slate-700" },
    { key: "windowInstaller", icon: "🪟", color: "from-slate-600 to-slate-700" },
    { key: "gutterSpecialist", icon: "💧", color: "from-slate-600 to-slate-700" },
    { key: "drivewaySpecialist", icon: "🛣️", color: "from-slate-600 to-slate-700" },
    { key: "fencing", icon: "🚧", color: "from-slate-600 to-slate-700" },
