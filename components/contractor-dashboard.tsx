              ...
              <CardHeader className="p-3 sm:p-6">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center w-full overflow-hidden">
                    <h2 className="text-xl font-semibold text-foreground truncate break-words px-2">
                      {profile.company_name}
                    </h2>
                    <p className="text-sm text-muted-foreground truncate break-words px-2">{profile.industry}</p>
